...
class fixed {
    ...
    protected static final String LK2 = "sd1e1gQJuvqBfZxas1oeAACXzbim5cge";
    protected static final String K2 = "G1rXOpMLQS77VPWEGycOSxekCTZe2Q8M";
    ...
    private static final String bbs_version = "2.80.1";
